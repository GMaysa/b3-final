...
function Home() {
  ...
  const handleSubmit = async (e) => {
    ...
    let data = JSON.stringify({
      ...
      passengers: {passengers_detail: passengers, count_passengers: passengerCount},
    ...
    dispatch(getAllFlightSearchResult(seatClass.toUpperCase(), searchTerm.from.iata, searchTerm.to.iata, thisDate(datePick[0].startDate), navigate))
  };
